    ...
    >
      <div class="d-flex flex-column text-right pr-3">
        ...
        <span
          ...
          >{{ currentUser.position_title }}</span
        >
      </div>
      <span class="symbol symbol-35">
        <span
          v-if="currentUser.hasOwnProperty('first_name')"
          class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30"
          >{{ currentUser.first_name.charAt(0) }}</span
        >
      </span>
    </div>
      ...
      >
        ...
        <div class="d-flex align-items-center mt-5">
          ...
          <div class="d-flex flex-column">
            ...
            <div class="text-muted mt-1">{{ currentUser.employee_no}}</div>
            <div class="navi mt-2">
                ...
                <span class="navi-link p-0 pb-2">
                  <span class="navi-icon mr-1">
                    <span class="svg-icon svg-icon-lg svg-icon-primary">
                      <!--begin::Svg Icon-->
                      <inline-svg
                        :src="resolveImagePath('media/svg/icons/Communication/Mail-notification.svg')"
                      />
                      <!--end::Svg Icon-->
                    </span>
                  </span>
              ...
              <div class="symbol symbol-40 bg-light mr-3">
                <div class="symbol-label">
                  <span class="svg-icon svg-icon-md svg-icon-success">
                    <!--begin::Svg Icon-->
                    <inline-svg
                      :src="resolveImagePath('media/svg/icons/General/Notification2.svg')"
                    />
                    <!--end::Svg Icon-->
                  </span>
                </div>
            ...
            >
              ...
              >
                <span class="svg-icon svg-icon-lg">
                  <!--begin::Svg Icon-->
                  <inline-svg :src="resolveImagePath(item.svg)" />
                  <!--end::Svg Icon-->
                </span>
              </span>
